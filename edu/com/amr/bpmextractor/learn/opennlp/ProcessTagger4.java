...
public class ProcessTagger4 {
	...
	public static void main(String[] args) {
		ProcessTagger4 pt = new ProcessTagger4();
		pt.startProcessing();
	}
	...
	private void appendVerbToTaskName(String token) {
		...
		if (currentTaskName != null && currentTaskName.length() > 0) {
			...
			currentTaskName = Utils.toCamelCase(token);
		}
	}
	...
	private void printTask() {
		if (currentTaskName != null && currentTaskName.length() > 0 && currentTaskName.contains(" ") ) {
